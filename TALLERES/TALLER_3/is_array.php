...
$miArray = ["carro", "casa", "perro"]; // Reemplaza esto con tu propio array
$miString = "Yezer"; // Reemplaza esto con tu propio string
$miNumero = 24; // Reemplaza esto con tu propio número
