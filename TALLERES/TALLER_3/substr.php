...
echo "</br>Extracto 1: $extracto1</br>";
echo "</br>Extracto 2: $extracto2</br>";
...
echo "</br>Últimas letras: $ultimasPalabras</br>";
...
echo "</br>Número de tarjeta oculto: " . ocultarTarjeta($tarjeta) . "</br>";
