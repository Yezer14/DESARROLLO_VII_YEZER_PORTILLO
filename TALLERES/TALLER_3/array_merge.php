...
$misComidas = ["lasagna", "pizza", "sushi"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["hamburguesa", "pasta", "arepa"]; // Reemplaza con las comidas favoritas de tu amigo
