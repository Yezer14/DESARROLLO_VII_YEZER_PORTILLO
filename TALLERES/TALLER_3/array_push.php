...
$misAmigos = ["david", "ezra", "joseph"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "jafet", "joel"); // Reemplaza las comillas vacías con los nombres de tus amigos
